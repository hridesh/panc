 ...
 * float} in an object. An object of type {@code Float} contains a
 * single field value whose type is {@code float}. Adapted from
 * {@link java.lang.Float} to act like a Long and provide the
 * 'duck' behavior required by capsules.
 */
public class Float extends Number
    implements Panini$Duck<java.lang.Float>, Comparable<Float> {
	/**
   ...
   /**
     ...
     * @since JDK1.1
     */
    public static final Class<java.lang.Float> TYPE = java.lang.Float.TYPE;
     ...
     * <li> the {@link #panini$finish(Float)} method is called. </li>
     * </ol>
     * @serial
     */
    private float value;
     ...
     * or when the {@link #panini$finish(Float)} method is called.
     */
     ...
     *
     * @param f    {@code java.lang.Float} to use as a value. Method will pull
     *             the wrapped {@code float} out as the value.
     */
    @Override
    public void panini$finish(java.lang.Float f) {
        synchronized(this) {
            value = f.floatValue();
     ...
     * Save the value and notify listeners the value is available.
     *
     * Does the same thing as {@link #panini$finish(Float)}, but for
     * a {@code long} instead of a {@code Long}.
     *
     * @param f    {@code long} to use as a value.
     */
    public void panini$finish(float f) {
        synchronized(this) {
            value = f;
            panini$redeemed = true;
            notifyAll();
     ...
     */
    @Override
    public java.lang.Float panini$get() {
    ...
    /**
     * Constructs a new {@code Duck$Float} which does
     ...
     */
    public Float(int panini$message$id) {
     ...
     * represents the specified {@code float} argument.
     *
     * A {@code Duck$Float} constructed with this constructor
    ...
    /**
     * Constructs a newly allocated {@code Float} object that
     * represents the {@code float} value indicated by the
    ...
    public boolean equals(java.lang.Object obj) {
    	...
    	if(obj instanceof Float){
    		return floatToIntBits(((Float)obj).floatValue()) == floatToIntBits(value);
    	}
    	else if(obj instanceof java.lang.Float){
    		return floatToIntBits(((java.lang.Float)obj).floatValue()) == floatToIntBits(value);
    	}
        return false;
    ...
    public int compareTo(Float anotherFloat) {
        return Float.compare(value, anotherFloat.floatValue());
    }
